...
export default function Login({closeModal}) {
    ...
    return (
        <div className="selection:bg-rose-500 selection:text-white">
            <div
                className="flex justify-center max-w-xl items-center">
                <div className="flex-1">
                    <div
                        className="w-full bg-white rounded-3xl mx-auto overflow-hidden  ">
                        <div className="relative h-48 bg-rose-500 rounded-4xl">
                            <div className="pb-3 text-center text-2xl font-bold text-white px-6 py-10">Login</div>
                        ...
                        <div className="px-10 pt-4 pb-8 bg-white rounded-tr-4xl">
                            <form className="mt-12" action="" method="POST">
                                <div className="relative">
                                    <input id="email" name="email" type="text"
                                           className="peer rounded-lg h-10 w-full border-b-2 border-gray-300 text-gray-900 placeholder-transparent focus:outline-none focus:border-rose-600"
                            ...
                            <a href="#"
                               className="mt-4 block text-sm text-center font-medium text-rose-600 hover:underline focus:outline-none focus:ring-2 focus:ring-rose-500"> Forgot
                                your password? </a>
                        </div>
                    </div>
                </div>
